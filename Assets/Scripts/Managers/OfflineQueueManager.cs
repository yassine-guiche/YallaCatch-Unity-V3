...
namespace YallaCatch.Managers
{
    ...
    public class OfflineQueueManager : MonoBehaviour
    {
        ...
        private IEnumerator CheckConnection()
        {
            ...
            using (UnityEngine.Networking.UnityWebRequest www = UnityEngine.Networking.UnityWebRequest.Get(APIManager.Instance.GetBaseURL() + "/health"))
            {
                www.timeout = 5; // 5 second timeout for health check
                yield return www.SendWebRequest();
                IsOnline = www.result == UnityEngine.Networking.UnityWebRequest.Result.Success;
            }
