    ...
    public class ConfigManager : MonoBehaviour
    {
        ...
        private IEnumerator LoadConfig()
        {
            if (APIClient.Instance != null && !APIClient.Instance.IsAuthenticated)
            {
                ...
                Debug.Log("[ConfigManager] Skipping backend config load until player is authenticated. Using local/default config.");
                yield break;
            }
        ...
        /// <summary>
        /// Compatibility helper for systems that request a heatmap city filter.
        /// City resolution is not part of ConfigManager yet, so return empty to fetch global heatmap data.
        /// </summary>
