...
namespace YallaCatch.API
{
    ...
    public class LocationUpdateResponse
    {
        ...
        public List<GamePrizeWire> nearbyPrizes;
    ...
    {
        public List<GamePrizeWire> prizes;
        public List<GamePartnerWire> partners;
        public List<GameMapMarkerWire> markers;
    ...
    public class GamePrizeWire
    {
        ...
        public GamePrizePosition position;
        public float distance;
        public DateTime expiresAt;
    }

    [Serializable]
    public class GamePrizePosition
    {
        public float lat;
        public float lng;
    }
    ...
    [Serializable]
    public class GamePartnerWire
    {
        public string id;
        public string name;
        public string category;
        public string logo;
        public List<GamePartnerLocationWire> locations;
    }

    [Serializable]
    public class GamePartnerLocationWire
    {
        public string id;
        public string name;
        public GamePrizePosition position;
    ...
    [Serializable]
    public class GameMapMarkerWire
    {
        public string id;
        public string type;
        public string title;
