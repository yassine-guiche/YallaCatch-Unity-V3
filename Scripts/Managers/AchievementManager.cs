...
namespace YallaCatch.Managers
{
    ...
    public class AchievementManager : MonoBehaviour
    {
        ...
        {
            yield return StartCoroutine(APIManager.Instance.GetAchievements((achievements) =>
            {
        ...
        private IEnumerator UnlockAchievement(Achievement achievement)
        {
            ...
            yield return StartCoroutine(APIManager.Instance.UnlockAchievement(achievement._id, (success, points) =>
            {
                if (success)
                {
