namespace YallaCatch.API
{
    ...
    public static class APIEndpoints
    {
        ...
        public const string AUTH_ME = API_VERSION + "/auth/me";
        ...
        // Partner data is populated inline via partnerId on Reward objects
        // No dedicated /rewards/partners endpoint exists on the backend

        #endregion

        #region Marketplace Endpoints

        public const string MARKETPLACE_LIST = API_VERSION + "/marketplace/items"; // Backend serves at /items
